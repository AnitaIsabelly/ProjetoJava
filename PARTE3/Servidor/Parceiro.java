...
public class Parceiro
{
  ...
  */
  private Semaphore mutEx = new Semaphore (1,true);
    ...
    /**
    Construtor da classe, que recebe como parametro o socket de conexao, o receptor, transmissor. Serve para fazer a comunicação de cliente - servidor.  recebe os parametros e faz validacao, se nao for nulo, os parametros sao armazenados nos atributos.
